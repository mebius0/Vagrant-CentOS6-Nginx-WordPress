...
when 5
	...
	default['yum']['remi-php55']['baseurl'] = 'http://rpms.famillecollet.com/enterprise/5/remi/$basearch/'
	default['yum']['remi-php55']['mirrorlist'] = 'http://rpms.famillecollet.com/enterprise/5/remi/mirror'
...
when 6
	...
	default['yum']['remi-php55']['baseurl'] = 'http://rpms.famillecollet.com/enterprise/6/remi/$basearch/'
	default['yum']['remi-php55']['mirrorlist'] = 'http://rpms.famillecollet.com/enterprise/6/remi/mirror'
	default['yum']['remi-php55']['gpgkey'] = 'http://rpms.famillecollet.com/RPM-GPG-KEY-remi'
when 7
	default['yum']['remi-php55']['description'] = 'Les RPM de remi pour Enterprise Linux 7 - $basearch'
	default['yum']['remi-php55']['baseurl'] = 'http://rpms.famillecollet.com/enterprise/7/remi/$basearch/'
	default['yum']['remi-php55']['mirrorlist'] = 'http://rpms.famillecollet.com/enterprise/7/remi/mirror'
	default['yum']['remi-php55']['gpgkey'] = 'http://rpms.famillecollet.com/RPM-GPG-KEY-remi'
end
